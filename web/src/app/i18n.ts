...
const zhToEn: Record<string, string> = {
  ...
  "客户端密钥": "Client Keys",
	...
	"生成 Key": "Generate key",
	"编辑访问权限": "Edit access policy",
	"权限": "Policy",
	"权 限": "Policy",
	"保存权限": "Save policy",
	"访问鉴权尚未开启": "Gateway authentication is not enabled",
	"访问鉴权已开启": "Gateway authentication enabled",
	"启用访问鉴权失败": "Failed to enable gateway authentication",
	"启用鉴权": "Enable authentication",
	"还没有访问密钥": "No access keys yet",
	"请先生成一个访问密钥，再继续配置应用。": "Generate an access key before configuring this application.",
	"撤销访问密钥？": "Revoke access key?",
	"删除访问密钥？": "Delete access key?",
	"确认删除": "Delete",
	"删除密钥失败": "Failed to delete key",
	"将彻底删除": "Permanently delete",
	"的这条已撤销或已过期密钥及其索引，此操作无法恢复。": "revoked or expired key and its indexes. This cannot be undone.",
	"轮换访问密钥": "Rotate access key",
	"访问密钥已生成": "Access key created",
	"完整 Key 只在这里显示": "The complete key is shown only here",
	"AI Router 访问密钥": "AI Router access key",
	"保留应用当前密钥": "Keep the application's current key",
	"保留应用当前密钥，或输入/选择密钥": "Keep the current key, or enter/select a key",
	"手动输入外部 Key": "Enter an external key manually",
	"外部 Key": "External key",
	"输入要写入该应用的 Key": "Enter the key to write to this application",
	"托管 Key": "Managed key",
	"仅验证 Key": "Verification-only key",
	"直接生成网关 Key；需要配置应用时，在“应用配置”中选择对应 Key。当前有": "Generate a gateway key directly, then select it in Applications. Available models:",
	"个可用模型。": "models.",
	"先生成 Key，再到“应用配置”选择并写入；确认可用后即可启用鉴权。": "Generate a key, select and write it in Applications, then enable authentication after verification.",
	"迁移后原 Key 保持不变；此类 Key 只能用于验证，不能在应用配置中重新选择。": "Migration keeps the original key unchanged. This type can authenticate requests but cannot be selected again in Applications.",
	"我确认该公网监听 Key 不设置速率、并发或每日配额": "I confirm this public-gateway key has no rate, concurrency, or daily quota",
	"默认保留旧 Key": "The previous key remains active by default",
	"生成后可在“应用配置”中选择新 Key；确认应用切换完成后再撤销旧 Key。": "Select the new key in Applications after generation, then revoke the old key once the switch is complete.",
	"生成后立即撤销旧 Key": "Revoke the previous key immediately",
	"生成新 Key": "Generate new key",
	"AI Router 已加密托管，可在“应用配置”中按名称选择；管理页面不会再次返回完整内容。": "AI Router stores it encrypted so it can be selected by name in Applications; management pages never return the complete value again.",
	"保存后由 AI Router 安全写入此托管 Key": "AI Router will securely write this managed key when saved",
	"可在应用配置中重复使用": "Reusable in Applications",
	"仅验证，无法重新写入": "Verification only; cannot be written again",
	"选择托管 Key 时，完整内容不会发送到浏览器": "The complete value is never sent to the browser when selecting a managed key",
  "应用配置": "Applications",
  "调用日志": "Request Logs",
  "系统设置": "Settings",
  "为 Codex、Claude Code、SDK 和自动化任务生成独立密钥，并控制访问范围与用量。": "Create separate keys for Codex, Claude Code, SDKs, and automation, with access and usage controls.",
  "创建客户端": "Create client",
  "备份状态": "Back up state",
  "客户端状态已备份": "Client state backed up",
  "备份客户端状态失败": "Failed to back up client state",
  "客户端鉴权尚未开启": "Client authentication is not enabled",
  "先创建密钥并写入应用，再在一次性密钥窗口中启用鉴权；验证失败会自动回滚。": "Create a key and deploy it to applications first, then enable authentication from the one-time key window. Failed verification rolls back automatically.",
  "旧版静态密钥": "Legacy static keys",
  "迁移后原 Key 保持不变，并从 YAML 静态配置转入托管状态库。": "Migration keeps the existing key unchanged and moves it from YAML into the managed state store.",
  "迁移": "Migrate",
	"迁 移": "Migrate",
  "旧密钥已迁移": "Legacy key migrated",
  "迁移旧密钥失败": "Failed to migrate legacy key",
  "读取客户端密钥失败": "Failed to load client keys",
  "请输入客户端名称": "Enter a client name",
  "请选择要写入应用的默认模型": "Select the default model to deploy to applications",
  "创建客户端密钥失败": "Failed to create client key",
  "保存客户端策略失败": "Failed to save client policy",
  "修改客户端状态失败": "Failed to change client status",
  "删除客户端失败": "Failed to delete client",
  "修改密钥失败": "Failed to update key",
  "客户端": "Client",
  "密钥": "Key",
  "访问范围": "Access",
  "限制": "Limits",
  "今日用量": "Today",
  "最近使用 / 到期": "Last used / expires",
  "个有效密钥": "active keys",
  "永不过期": "Never expires",
  "尚未生成": "Not generated",
  "全部模型": "All models",
  ...
  "已过期": "Expired",
  "已撤销": "Revoked",
  "还没有客户端密钥": "No client keys yet",
  "该客户端还没有密钥": "This client has no keys yet",
  "尚未使用": "Never used",
  "轮换": "Rotate",
  "轮 换": "Rotate",
  "轮换客户端密钥": "Rotate client key",
  "默认保留旧密钥": "The previous key remains active by default",
  "先把新密钥写入并验证应用，再按需立即撤销旧密钥，可避免调用中断。": "Deploy and verify the new key first, then revoke the previous key if needed to avoid interruption.",
  "写入后立即撤销旧密钥": "Revoke the previous key after deployment",
  "不选择应用时只生成新密钥，旧密钥默认继续有效。": "With no application selected, only a new key is generated and the previous key remains active.",
  "生成并轮换": "Generate and rotate",
  "轮换中…": "Rotating…",
  "轮换密钥失败": "Failed to rotate key",
  "撤销": "Revoke",
  "撤 销": "Revoke",
  "撤销客户端密钥？": "Revoke client key?",
  "确认撤销": "Confirm revocation",
  "撤销后无法恢复；正在进行的请求可正常结束，新请求会立即被拒绝。": "Revocation cannot be undone. In-flight requests may finish, while new requests are rejected immediately.",
  "编辑客户端策略": "Edit client policy",
  "删除客户端？": "Delete client?",
  "删除客户端": "Delete client",
  "客户端名称": "Client name",
  "例如：我的 Codex": "For example: My Codex",
  "说明": "Description",
  "设备、团队或自动化任务": "Device, team, or automation job",
  "过期时间": "Expiration",
  "允许模型": "Allowed models",
  "留空表示全部模型，多个用逗号分隔": "Leave empty for all models; separate multiple values with commas",
  "允许来源 IP / CIDR": "Allowed source IP / CIDR",
  "留空表示不限制，例如 10.0.0.0/8, 192.168.1.10/32": "Leave empty for no restriction, for example 10.0.0.0/8, 192.168.1.10/32",
  "允许协议": "Allowed protocols",
  "不勾选表示允许全部协议": "Select none to allow every protocol",
  "每分钟请求": "Requests per minute",
  "突发容量": "Burst capacity",
  "默认等于 RPM": "Defaults to RPM",
  "最大并发": "Maximum concurrency",
  "每日请求": "Daily requests",
  "每日输入 Token": "Daily input tokens",
  "每日输出 Token": "Daily output tokens",
  "单次最大输出 Token": "Maximum output tokens per request",
  "立即配置到应用": "Deploy to applications now",
  "应用默认模型": "Application default model",
  "请选择模型": "Select a model",
  "生成密钥": "Generate key",
  "保存策略": "Save policy",
  "我确认该公网监听客户端不设置速率、并发或每日配额": "I confirm this public-gateway client has no rate, concurrency, or daily quota",
  "客户端密钥已生成": "Client key created",
  "完整密钥只显示这一次": "The full key is shown only once",
  "关闭窗口后无法恢复。AI Router 只保存不可逆摘要。": "It cannot be recovered after this window closes. AI Router stores only an irreversible digest.",
  "已复制": "Copied",
  "复制": "Copy",
  "我已保存，关闭": "I saved it, close",
  "验证密钥并启用鉴权": "Verify key and enable authentication",
  "正在验证并启用…": "Verifying and enabling…",
  "所选应用尚未全部写入并验证，暂不能启用客户端鉴权。": "Client authentication cannot be enabled until every selected application is deployed and verified.",
  "外部或旧版密钥": "External or legacy key",
  "保留当前密钥": "Keep current key",
  "标准托管密钥不会在应用配置页重新显示完整内容": "A managed key is never shown in full again on the application page",
  "生成或轮换专用密钥": "Generate or rotate a dedicated key",
  "托管密钥": "Managed key",
  "状态未知": "Unknown status",
...
const dynamicFragments: Array<[string, string]> = [
  ...
  ["并发", "concurrent"],
  ["次请求", "requests"],
  ["已转为托管客户端密钥", "is now a managed client key"],
  ["这是", "This is"],
  ["最后一个有效密钥。撤销后，该客户端将无法再通过托管密钥访问网关。", "last active key. After revocation, this client can no longer access the gateway with a managed key."],
];
...
export function translateValue(value: string, locale: Locale): string {
  ...
  if (locale === "en-US") {
    return value
      ...
      .replace(/^共 (\d+) 个客户端$/, "$1 clients")
			.replace(/^共 (\d+) 个访问密钥$/, "$1 access keys")
  ...
  return value
    ...
    .replace(/^(\d+) clients$/, "共 $1 个客户端")
		.replace(/^(\d+) access keys$/, "共 $1 个访问密钥")
